...
const SuccessPopup = ({ onClose }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex justify-center items-center px-4 sm:px-6 md:px-10 lg:px-20" onClick={onClose}>
            <div
                className="bg-white p-6 sm:p-8 rounded-lg w-full max-w-md md:max-w-lg lg:max-w-2xl h-auto max-h-[80vh] relative flex flex-col justify-center items-center overflow-hidden"
